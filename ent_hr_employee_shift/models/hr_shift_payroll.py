...
class HrPayroll(models.Model):
    ...
    def get_worked_day_lines(self, contract_ids, date_from, date_to):
        """
        @param contract_ids: list of contract id @return: returns a list of
        dict containing the input that should be applied for the given
        ...
        for contract in contract_ids:
            ...
            for days in contract.shift_schedule:
                ...
                for day in range(0, nb_of_days):
                    working_intervals_on_day = days.\
                        hr_shift._get_day_work_intervals(
            ...
            # Extract information from previous data. A working interval is
            # considered: - as a leave if a hr.holiday completely covers the
            # period - as a working period instead
            ...
            for data in [attendances] + leaves:
                data['number_of_days'] = uom_hour.\
                    _compute_quantity(data['number_of_hours'], uom_day) \
