...
class HrEmployeeBroadFactor(models.Model):
    """Inherits the model hr.employee.broad.factor to add extra fields and
    methods to complete the functionality"""
...
class ReportBroadFactor(models.AbstractModel):
    """Creates the model report.hrms_dashboard.report_broad_factor for creating
    the report"""
