...
class HrAllocationReport(models.TransientModel):
    ...
    def action_print_pdf(self):
        ...
        if self.filter == 'employee_wise':
            ...
            return self.env.ref(
                'ent_ohrms_employee_accommodation_management.'
