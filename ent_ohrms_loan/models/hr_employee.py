...
class HrEmployee(models.Model):
    """Inherit hr.employee to compute number of loans for employees."""
    _inherit = "hr.employee"

    loan_count = fields.Integer(string="Loan Count", help="Number of loans associated with the employee.",
