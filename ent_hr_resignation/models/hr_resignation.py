...
class HrResignation(models.Model):
    ...
    notice_period = fields.Char(string="Notice Period",
                                help="Notice period for employee")
    ...
    def _onchange_employee_id(self):
        ...
        self.notice_period = self.employee_id.notice_days
    ...
    def check_employee(self):
        ...
        for rec in self:
            if (not self.env.user.has_group(
                    'hr.group_hr_user') and rec.employee_id.user_id.id and rec.employee_id.user_id.id != self.env.uid):
